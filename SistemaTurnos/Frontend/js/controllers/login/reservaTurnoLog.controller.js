        ...
        if(fechaDeHoy.getMonth() == mesActualNumber)
          ...
          for(let index = initDay; index < fechasHTML.children.length; index++) {
              ...
              element.addEventListener('click', (event) => 
              {
                  ...
                  //getReservas
                  getTurnosByParamAuth('-1',selectedDay,sucursalesId.value).then((r) => {
                    console.log(r)
                      if(r.length>0)  
                      {
